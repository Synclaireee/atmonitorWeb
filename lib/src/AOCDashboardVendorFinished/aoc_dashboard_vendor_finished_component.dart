...
@Component(
  ...
  templateUrl: 'aoc_dashboard_vendor_finished_component.html',
  directives: [
    coreDirectives,
...
class AOCDashboardVendorFinishedComponent implements OnInit, OnDestroy {
  Router _route;
  ...
  AOCDashboardVendorFinishedComponent(this._route);
