...
@Component(
  ...
  templateUrl: 'aoc_dashboard_pkt_component.html',
  directives: [
    coreDirectives,
...
class AOCDashboardPKTComponent implements OnInit, OnDestroy {
  Router _route;
  ...
  AOCDashboardPKTComponent(this._route);
  ...
  //force Reload
  reload() {
    _route.navigate(RoutePaths.AOCDashboardPKT.toUrl(),
